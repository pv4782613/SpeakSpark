...
<img src="res/qc_login.png" style="height:190px;">
</div>
<input type="text" name="Username"  placeholder="Username" required>
<input type="password" name="Password" placeholder="Password" required>
<input type="submit" name="submit" class="submit1" value="submit">
<p class="new">New User?<a href="qc_registration.html" target="_blank" >Click Here</a></p>
</form>
<?php
}
elseif($_SERVER['REQUEST_METHOD']=='POST')
{
	if(!empty($_POST['submit']))
	{
		...
		$query="select * from qc_selected where Username='$Username' and Password='$Password'";
		...
		if($count>0)
		{
			...
			echo "<br><a href='qc_main_page.html' class='a2' target='_blank'>Proceed</a>";
		}
		else
		{
			echo "<p class='a11'>Invalid Credentials!! </p>";
			echo "<br><a href='qc_login_page.php' class='a22'>Try Again</a>";
		}
	}
}
else
