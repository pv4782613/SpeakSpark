...
if(isset($_POST['submit'])) {
    ...
    if ($fileerror == 0 && $fileerror1 == 0 && $fileerror2 == 0 && $fileerror3 == 0 && $fileerror4==0) 
	{
        ...
        else 
		{
            ...
            $insertquery = "INSERT INTO tutor_registration(full_name, Email, Username, Confirm, Aadhar, Pan, Bank, Education,profile,Country,Introduction) VALUES ('$full_name', '$Email', '$Username', '$Confirm', '$destfile', '$destfile1', '$destfile2', '$destfile3','$destfile4','$Country','$Introduction')";
			
			$insertquery1 = "INSERT INTO tutor_profile(full_name, Email, Username, Confirm, Aadhar, Pan, Bank, Education,profile,Country,Introduction) VALUES ('$full_name', '$Email', '$Username', '$Confirm', '$destfile', '$destfile1', '$destfile2', '$destfile3','$destfile4','$Country','$Introduction')";
