...
<body>
<table id="view">
<tr><th>full_name</th> <th>Email</th> <th>Username</th>  <th>Password</th>  <th>Aadhar</th> <th>Pan</th> <th>Bank</th>  <th>Education</th> <th>Hire the QC</th> 
</tr>
<tbody>
<?php 
include 'dbcon.php';
$selectquery="select * from qc_registration";
...
<td>
  <form action="select_qc.php" method="post">
